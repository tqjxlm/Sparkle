...
// Averages the GPU time of a set of passes and logs the means periodically. A frame
...
public:
    ...
    void AddStage(std::string name, RHIResourceRef<RHIPass> pass);
