...
static void SetupStyle()
{
    ...
    colors[ImGuiCol_Header] = ImVec4(0.30f, 0.44f, 0.60f, .5f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.19f, 0.19f, 0.19f, 0.33f);
    ...
    colors[ImGuiCol_TableHeaderBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.32f);
