...
[[vk::binding(1, 1)]] RWTexture2D<float4> imageData : register(u1);
[[vk::binding(2, 1)]] StructuredBuffer<uint> materialIdBuffer : register(t2);
[[vk::binding(3, 1)]] StructuredBuffer<MaterialParameters> materialBuffer : register(t3);
[[vk::binding(4, 1)]] TextureCube<float4> skyMap : register(t4);
[[vk::binding(5, 1)]] SamplerState skyMapSampler : register(s0);
[[vk::binding(6, 1)]] SamplerState materialTextureSampler : register(s1);

// set 2: bindless resources, shared by the whole scene
[[vk::binding(0, 2)]] Texture2D textures[] : register(t5);
[[vk::binding(1, 2)]] StructuredBuffer<uint> indexBuffers[] : register(t6);
[[vk::binding(2, 2)]] StructuredBuffer<float> vertexBuffers[] : register(t7);
[[vk::binding(3, 2)]] StructuredBuffer<VertexAttribute> vertexAttributeBuffers[] : register(t8);
